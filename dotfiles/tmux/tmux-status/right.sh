...
[[ -z "$segment_fg" ]] && segment_fg="#c5c8c6"
# Host/time segment color: use @theme_color set by update_theme_color.sh (normal=green, insert=purple)
host_bg=$(tmux show -gqv '@theme_color')
[[ -z "$host_bg" ]] && host_bg="#b5e8a8"
host_fg="#1d1f21"
